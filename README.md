...
- **Som de 1/20 natural**: toca um som quando um personagem jogador rola 1 ou 20 natural em qualquer teste de d20 (ataque, resistência, perícia, iniciativa etc.). Não dispara em rolagens de NPCs/monstros. Ativado/volume configuráveis em Configurações do Mundo → **Pf2e Mestre Weber**. Padrão: ativado, volume 0.8.
