...
- **Som e susto de 1/20 natural**: quando um personagem jogador rola 1 ou 20 natural em qualquer teste de d20 (ataque, resistência, perícia, iniciativa etc.), toca um som e a tela treme. No 20, aparece um "20" gigante e dourado por cima da tela. No 1, pisca rapidamente (tipo raio) uma imagem sorteada da pasta `images/lordes-demonios/` do módulo — adicione mais imagens `.png`/`.jpg`/`.webp`/`.gif` nessa pasta a qualquer momento (o Mestre precisa recarregar o mundo uma vez para a lista ser atualizada). Não dispara em rolagens de NPCs/monstros. Ativado/volume configuráveis em Configurações do Mundo → **Pf2e Mestre Weber**. Padrão: ativado, volume 0.8.
